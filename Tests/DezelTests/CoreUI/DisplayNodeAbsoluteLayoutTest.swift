...
class DisplayNodeAbsoluteLayoutTest: XCTestCase {
	...
	func testNodePositionInPX() {
		...
		node.setTop(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitPX, length: 10)
		node.setLeft(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitPX, length: 20)
		node.setRight(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitPX, length: 30)
		node.setBottom(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitPX, length: 40)
	...
	func testNodePositionInPC() {
		...
		let node = DisplayNode(display: self.display)
		node.setTop(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitPC, length: 10)
		node.setLeft(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitPC, length: 20)
		node.setRight(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitPC, length: 30)
		node.setBottom(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitPC, length: 40)
	...
	func testNodePositionInVW() {
		...
		let node = DisplayNode(display: self.display)
		node.setTop(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitVW, length: 10)
		node.setLeft(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitVW, length: 20)
		node.setRight(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitVW, length: 30)
		node.setBottom(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitVW, length: 40)
	...
	func testNodePositionInVH() {
		...
		let node = DisplayNode(display: self.display)
		node.setTop(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitVH, length: 10)
		node.setLeft(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitVH, length: 20)
		node.setRight(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitVH, length: 30)
		node.setBottom(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitVH, length: 40)
	...
	func testNodePositionInPW() {
		...
		let node = DisplayNode(display: self.display)
		node.setTop(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitPW, length: 10)
		node.setLeft(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitPW, length: 20)
		node.setRight(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitPW, length: 30)
		node.setBottom(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitPW, length: 40)
	...
	func testNodePositionInPH() {
		...
		let node = DisplayNode(display: self.display)
		node.setTop(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitPH, length: 10)
		node.setLeft(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitPH, length: 20)
		node.setRight(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitPH, length: 30)
		node.setBottom(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitPH, length: 40)
	...
	func testNodePositionInCW() {
		...
		let node = DisplayNode(display: self.display)
		node.setTop(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitCW, length: 10)
		node.setLeft(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitCW, length: 20)
		node.setRight(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitCW, length: 30)
		node.setBottom(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitCW, length: 40)
	...
	func testNodePositionInCH() {
		...
		let node = DisplayNode(display: self.display)
		node.setTop(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitCH, length: 10)
		node.setLeft(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitCH, length: 20)
		node.setRight(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitCH, length: 30)
		node.setBottom(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitCH, length: 40)
	...
	func testNodeMarginInPW() {
		...
		let node = DisplayNode(display: self.display)
		node.setTop(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitPX, length: 0)
		node.setLeft(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitPX, length: 0)
	...
	func testNodeWidthUsingFillAndLeftPosition() {
		...
		let node = DisplayNode(display: self.display)
		node.setLeft(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitPX, length: 10)
		node.setWidth(type: kDisplayNodeSizeTypeFill, unit: kDisplayNodeSizeUnitNone, length: 0)
		node.setHeight(type: kDisplayNodeSizeTypeFill, unit: kDisplayNodeSizeUnitNone, length: 0)
	...
	func testNodeWidthUsingLeftAndRightPositionInPXIncludingNegativeMargin() {
	...
	func testNodeWidthUsingLeftAndRightPositionInPXIncludingPositiveMargin() {
	...
	func testNodeHeightUsingTopAndBottomPositionInPXIncludingNegativeMargin() {
	...
	func testNodeHeightUsingTopAndBottomPositionInPXIncludingPositiveMargin() {
...
func testNodeBorderInCW() {
	...
	func testWrappingFromContentSize() {
		...
		container.setTop(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitPX, length: 0)
	...
	func testWrappingFromContentSizeWithMin() {
		...
		node1.setTop(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitPX, length: 0)
		node1.setWidth(type: kDisplayNodeSizeTypeLength, unit: kDisplayNodeSizeUnitPX, length: 200)
		node1.setHeight(type: kDisplayNodeSizeTypeLength, unit: kDisplayNodeSizeUnitPX, length: 200)

		let node2 = DisplayNode(display: self.display)
		node2.setName("Node 2");
		node2.setTop(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitPX, length: 200)
		node2.setWidth(type: kDisplayNodeSizeTypeLength, unit: kDisplayNodeSizeUnitPX, length: 200)
		node2.setHeight(type: kDisplayNodeSizeTypeLength, unit: kDisplayNodeSizeUnitPX, length: 200)
	...
	func testNodePositionAndSizeCaching() {
		...
		let node1 = DisplayNode(display: self.display)
		node1.setTop(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitPX, length: 10)
		node1.setLeft(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitPX, length: 20)
		node1.setWidth(type: kDisplayNodeSizeTypeLength, unit: kDisplayNodeSizeUnitPX, length: 200)
		node1.setHeight(type: kDisplayNodeSizeTypeLength, unit: kDisplayNodeSizeUnitPX, length: 200)
		node1.delegate = counter

		let node2 = DisplayNode(display: self.display)
		node2.setTop(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitPX, length: 10)
		node2.setLeft(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitPX, length: 20)
		node2.setWidth(type: kDisplayNodeSizeTypeLength, unit: kDisplayNodeSizeUnitPX, length: 200)
		node2.setHeight(type: kDisplayNodeSizeTypeLength, unit: kDisplayNodeSizeUnitPX, length: 200)
		...
		node3.setTop(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitPX, length: 10)
		node3.setLeft(type: kDisplayNodePositionTypeLength, unit: kDisplayNodePositionUnitPX, length: 20)
