...
__webpack_require__(/*! dezel/lib/web/Event */ "../dezel/lib/web/Event.js");
__webpack_require__(/*! dezel/lib/web/EventTarget */ "../dezel/lib/web/EventTarget.js");
__webpack_require__(/*! dezel/lib/web/WebSocket */ "../dezel/lib/web/WebSocket.js");
__webpack_require__(/*! dezel/lib/web/XMLHttpRequest */ "../dezel/lib/web/XMLHttpRequest.js");
__webpack_require__(/*! dezel/lib/web/XMLHttpRequestUpload */ "../dezel/lib/web/XMLHttpRequestUpload.js");
...
class TestRunner {
    ...
    constructor(host, port) {
        ...
        this.socket = (0, socket_io_client_1.io)(`http://${this.host}:${this.port}`, { forceBase64: true, transports: ['websocket'] });
    ...
    /**
     * Convenience method to emit a start event.
     * @method emitStart
     * @since 0.1.0
     */
    emitStart(data) {
    ...
    /**
     * Convenience method to emit an info event.
     * @method emitInfo
     * @since 0.1.0
     */
    emitInfo(data) {
    ...
    result(data) {
        ...
        if (__testRunnerResult__) {
            __testRunnerResult__(data);
        }
    }
    /**
     * @inherited
    ...
    complete(data) {
        ...
        if (__testRunnerComplete__) {
            __testRunnerComplete__(data);
        }
    }
    /**
     * @inherited
     ...
     */
    onConnect() {
        this.socket.emit('register', { id: `Dezel ${DEVICE_ID}`, name: `Dezel ${DEVICE_PLATFORM_NAME} ${DEVICE_PLATFORM_VERSION}` });
    }
    /**
 ...
 * @hidden
 */
function decorate(prototype, accessor) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CloseEvent = exports.MessageEvent = exports.ProgressEvent = exports.Event = void 0;
const Event_1 = __webpack_require__(/*! ./private/Event */ "../dezel/lib/web/private/Event.js");
/**
 * @class Event
 * @since 0.1.0
 */
...
__webpack_require__.g.MessageEvent = MessageEvent;
;
__webpack_require__.g.CloseEvent = CloseEvent;
//# sourceMappingURL=Event.js.map

/***/ }),

/***/ "../dezel/lib/web/EventTarget.js":
/*!***************************************!*\
  !*** ../dezel/lib/web/EventTarget.js ***!
  \***************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const EventTarget_1 = __webpack_require__(/*! ./private/EventTarget */ "../dezel/lib/web/private/EventTarget.js");
/**
 * @class EventTarget
 * @since 0.1.0
 * @hidden
 ...
 */
;
__webpack_require__.g.EventTarget = EventTarget;
//# sourceMappingURL=EventTarget.js.map

/***/ }),

/***/ "../dezel/lib/web/Exception.js":
/*!*************************************!*\
  !*** ../dezel/lib/web/Exception.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var _a, _b, _c;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Exception = exports.MESSAGE = exports.NAME = exports.CODE = void 0;
/**
 * @symbol CODE
 * @since 0.1.0
 */
 ...
 */
;
__webpack_require__.g.Exception = Exception;
//# sourceMappingURL=Exception.js.map

/***/ }),

/***/ "../dezel/lib/web/WebSocket.js":
/*!*************************************!*\
  !*** ../dezel/lib/web/WebSocket.js ***!
  \*************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const WebSocket_2 = __webpack_require__(/*! ./private/WebSocket */ "../dezel/lib/web/private/WebSocket.js");
const WebSocket_3 = __webpack_require__(/*! ./private/WebSocket */ "../dezel/lib/web/private/WebSocket.js");
const WebSocket_4 = __webpack_require__(/*! ./private/WebSocket */ "../dezel/lib/web/private/WebSocket.js");
const WebSocket_5 = __webpack_require__(/*! ./private/WebSocket */ "../dezel/lib/web/private/WebSocket.js");
const WebSocket_6 = __webpack_require__(/*! ./private/WebSocket */ "../dezel/lib/web/private/WebSocket.js");
const WebSocket_7 = __webpack_require__(/*! ./private/WebSocket */ "../dezel/lib/web/private/WebSocket.js");
const bridge_1 = __webpack_require__(/*! ../native/bridge */ "../dezel/lib/native/bridge.js");
const native_1 = __webpack_require__(/*! ../native/native */ "../dezel/lib/native/native.js");
const Event_1 = __webpack_require__(/*! ./Event */ "../dezel/lib/web/Event.js");
const Event_2 = __webpack_require__(/*! ./Event */ "../dezel/lib/web/Event.js");
const Event_3 = __webpack_require__(/*! ./Event */ "../dezel/lib/web/Event.js");
const EventTarget_1 = __webpack_require__(/*! ./EventTarget */ "../dezel/lib/web/EventTarget.js");
const Exception_1 = __webpack_require__(/*! ./Exception */ "../dezel/lib/web/Exception.js");
...
class WebSocket extends EventTarget_1.EventTarget {
    ...
    constructor(url, protocols = '') {
        ...
        (0, native_1.native)(this).open(url, protocols);
    }
    //--------------------------------------------------------------------------
    // Properties
    //--------------------------------------------------------------------------
    ...
    send(data) {
        ...
        (0, native_1.native)(this).send(data);
    }
    /**
     * @method send
     * @since 0.1.0
    ...
    close(code, reason) {
        ...
        this[WebSocket_6.$readyState] = WebSocket_1.CLOSING;
        (0, native_1.native)(this).close(code, reason);
    }
    //--------------------------------------------------------------------------
    // Native API
    //--------------------------------------------------------------------------
    ...
    nativeOnConnect(protocol, extensions) {
        ...
        this.dispatchEvent(new Event_2.Event('open'));
    }
    /**
    ...
    nativeOnReceiveMessage(message) {
        ...
        this.dispatchEvent(new Event_3.MessageEvent('message', { data: message }));
    }
    /**
     ...
     */
    nativeOnDisconnect() {
        if (this[WebSocket_6.$readyState] != WebSocket_1.CLOSED) {
            this[WebSocket_6.$readyState] = WebSocket_1.CLOSED;
            this.dispatchEvent(new Event_1.CloseEvent('close'));
        }
    }
    /**
...
WebSocket = WebSocket_1 = __decorate([
    (0, bridge_1.bridge)('dezel.global.WebSocket')
    /**
     * @class WebSocket
     * @super EventTarget
     * @since 0.1.0
 ...
 */
;
__webpack_require__.g.WebSocket = WebSocket;
//# sourceMappingURL=WebSocket.js.map

/***/ }),

/***/ "../dezel/lib/web/XMLHttpRequest.js":
/*!******************************************!*\
  !*** ../dezel/lib/web/XMLHttpRequest.js ***!
  \******************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const XMLHttpRequest_2 = __webpack_require__(/*! ./private/XMLHttpRequest */ "../dezel/lib/web/private/XMLHttpRequest.js");
const XMLHttpRequest_3 = __webpack_require__(/*! ./private/XMLHttpRequest */ "../dezel/lib/web/private/XMLHttpRequest.js");
const XMLHttpRequest_4 = __webpack_require__(/*! ./private/XMLHttpRequest */ "../dezel/lib/web/private/XMLHttpRequest.js");
const XMLHttpRequest_5 = __webpack_require__(/*! ./private/XMLHttpRequest */ "../dezel/lib/web/private/XMLHttpRequest.js");
const XMLHttpRequest_6 = __webpack_require__(/*! ./private/XMLHttpRequest */ "../dezel/lib/web/private/XMLHttpRequest.js");
const XMLHttpRequest_7 = __webpack_require__(/*! ./private/XMLHttpRequest */ "../dezel/lib/web/private/XMLHttpRequest.js");
const XMLHttpRequest_8 = __webpack_require__(/*! ./private/XMLHttpRequest */ "../dezel/lib/web/private/XMLHttpRequest.js");
const XMLHttpRequest_9 = __webpack_require__(/*! ./private/XMLHttpRequest */ "../dezel/lib/web/private/XMLHttpRequest.js");
const XMLHttpRequest_10 = __webpack_require__(/*! ./private/XMLHttpRequest */ "../dezel/lib/web/private/XMLHttpRequest.js");
const XMLHttpRequest_11 = __webpack_require__(/*! ./private/XMLHttpRequest */ "../dezel/lib/web/private/XMLHttpRequest.js");
const XMLHttpRequest_12 = __webpack_require__(/*! ./private/XMLHttpRequest */ "../dezel/lib/web/private/XMLHttpRequest.js");
const XMLHttpRequest_13 = __webpack_require__(/*! ./private/XMLHttpRequest */ "../dezel/lib/web/private/XMLHttpRequest.js");
const XMLHttpRequest_14 = __webpack_require__(/*! ./private/XMLHttpRequest */ "../dezel/lib/web/private/XMLHttpRequest.js");
const XMLHttpRequest_15 = __webpack_require__(/*! ./private/XMLHttpRequest */ "../dezel/lib/web/private/XMLHttpRequest.js");
const XMLHttpRequest_16 = __webpack_require__(/*! ./private/XMLHttpRequest */ "../dezel/lib/web/private/XMLHttpRequest.js");
const XMLHttpRequest_17 = __webpack_require__(/*! ./private/XMLHttpRequest */ "../dezel/lib/web/private/XMLHttpRequest.js");
const XMLHttpRequest_18 = __webpack_require__(/*! ./private/XMLHttpRequest */ "../dezel/lib/web/private/XMLHttpRequest.js");
const bridge_1 = __webpack_require__(/*! ../native/bridge */ "../dezel/lib/native/bridge.js");
const native_1 = __webpack_require__(/*! ../native/native */ "../dezel/lib/native/native.js");
const Event_1 = __webpack_require__(/*! ./Event */ "../dezel/lib/web/Event.js");
const Event_2 = __webpack_require__(/*! ./Event */ "../dezel/lib/web/Event.js");
...
class XMLHttpRequest extends EventTarget_1.EventTarget {
    ...
    send(data) {
        ...
        this[XMLHttpRequest_3.$error] = false;
        (0, native_1.native)(this).request(this[XMLHttpRequest_17.$url], this[XMLHttpRequest_5.$method], this[XMLHttpRequest_4.$headers], this[XMLHttpRequest_16.$timeout], this[XMLHttpRequest_18.$username], this[XMLHttpRequest_6.$password], data);
...
XMLHttpRequest = XMLHttpRequest_1 = __decorate([
    (0, bridge_1.bridge)('dezel.global.XMLHttpRequest')
    /**
     * @class XMLHttpRequest
     * @super EventTarget
     * @since 0.1.0
 ...
 */
;
__webpack_require__.g.XMLHttpRequest = XMLHttpRequest;
//# sourceMappingURL=XMLHttpRequest.js.map

/***/ }),

/***/ "../dezel/lib/web/XMLHttpRequestUpload.js":
/*!************************************************!*\
  !*** ../dezel/lib/web/XMLHttpRequestUpload.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.XMLHttpRequestUpload = void 0;
const EventTarget_1 = __webpack_require__(/*! ./EventTarget */ "../dezel/lib/web/EventTarget.js");
...
/***/ "../dezel/lib/web/private/Event.js":
/*!*****************************************!*\
  !*** ../dezel/lib/web/private/Event.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "../dezel/lib/web/private/EventTarget.js":
/*!***********************************************!*\
  !*** ../dezel/lib/web/private/EventTarget.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "../dezel/lib/web/private/WebSocket.js":
/*!*********************************************!*\
  !*** ../dezel/lib/web/private/WebSocket.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, exports) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.$bufferedAmount = exports.$binaryType = exports.$readyState = exports.$extensions = exports.$protocol = exports.$url = void 0;
/**
 * @symbol URL
 * @since 0.1.0
 */
...
/***/ "../dezel/lib/web/private/XMLHttpRequest.js":
/*!**************************************************!*\
  !*** ../dezel/lib/web/private/XMLHttpRequest.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.$abort = exports.$error = exports.$sent = exports.$statusText = exports.$statusCode = exports.$responseUrl = exports.$responseHeaders = exports.$responseType = exports.$responseText = exports.$response = exports.$password = exports.$username = exports.$timeout = exports.$headers = exports.$method = exports.$url = exports.$readyState = void 0;
/**
 * @symbol readyState
 * @since 0.1.0
 */
 ...
 */
new TestRunner_1.TestRunner(KARMA_HOST, KARMA_PORT);
